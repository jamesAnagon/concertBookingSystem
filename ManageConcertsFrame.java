...
public class ManageConcertsFrame extends JFrame {
    ...
    public ManageConcertsFrame() {
        ...
        // Table setup
        tableModel.setColumnIdentifiers(new Object[]{"id","concert_name","concert_date","ticket_price","regular_price","vip_price"});
        ...
        addFormRow(form, c, row++, "Ticket Price:", ticketPriceField, true);
    ...
    private void loadConcerts() {
        ...
        for (Map<String, Object> r : rows) {
            tableModel.addRow(new Object[]{
                    r.get("id"), r.get("concert_name"), r.get("concert_date"), r.get("ticket_price"), r.get("regular_price"), r.get("vip_price")
            });
        }
    }
    ...
    private void onTableSelect() {
        ...
        dateField.setText(String.valueOf(tableModel.getValueAt(modelRow, 2)));
        ticketPriceField.setText(String.valueOf(tableModel.getValueAt(modelRow, 3)));
        regularPriceField.setText(String.valueOf(tableModel.getValueAt(modelRow, 4)));
        vipPriceField.setText(String.valueOf(tableModel.getValueAt(modelRow, 5)));
    }
    ...
    private boolean validateForm(boolean requireId) {
        ...
        try { Double.parseDouble(ticketPriceField.getText().trim()); } catch (Exception ex) { return false; }
    ...
    private void onAdd() {
        ...
        try {
            ...
            boolean ok = concertDAO.addConcert(concertName, d, ticketPrice, regularPrice, vipPrice);
            if (ok) {
    ...
    private void onUpdate() {
        ...
        try {
            ...
            double regularPrice = Double.parseDouble(regularPriceField.getText().trim());
            double vipPrice = Double.parseDouble(vipPriceField.getText().trim());
            boolean ok = concertDAO.updateConcert(id, concertName, d, ticketPrice, regularPrice, vipPrice);
            if (ok) {
