...
public class ManageBookingsFrame extends JFrame {
    ...
    private void loadConcertOptions() {
        ...
        for (Map<String, Object> concert : availableConcerts) {
            concertCombo.addItem(String.valueOf(concert.getOrDefault("concert_name", "Untitled")));
        }
        refreshPriceLabel();
    }
    ...
    private void refreshPriceLabel() {
        ...
        double regularPrice = ((Number) selectedConcert.getOrDefault("regular_price", 0.0)).doubleValue();
        double vipPrice = ((Number) selectedConcert.getOrDefault("vip_price", regularPrice)).doubleValue();
        int qty = (Integer) quantitySpinner.getValue();
        double unitPrice = "VIP".equals(seatTypeCombo.getSelectedItem()) ? vipPrice : regularPrice;
    ...
    private void createBooking() {
        ...
        double regularPrice = ((Number) selectedConcert.getOrDefault("regular_price", 0.0)).doubleValue();
        double vipPrice = ((Number) selectedConcert.getOrDefault("vip_price", regularPrice)).doubleValue();
        double unitPrice = "VIP".equalsIgnoreCase(seatType) ? vipPrice : regularPrice;
